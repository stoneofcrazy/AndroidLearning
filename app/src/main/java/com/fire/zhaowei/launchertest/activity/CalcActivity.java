...
public class CalcActivity extends Activity {
    private final static String TAG = "ad";
    ...
    private TextView input;// 用于显示输出结果
    private TextView tip;
    private Button div, mul, sub, add, equal, sin, cos, tan, log, ln, sqrt,
            square, factorial, bksp, left, right, dot, c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdManager.getInstance(this).init("05f4b51958c71c7b", "d47722288e79f768", false);
        //设置广告条
        setupBannerAd();
    }
    ...
    private void setupBannerAd() {
        ...
        LinearLayout bannerLayout = (LinearLayout) findViewById(R.id.rl_native_ad);
    ...
    private OnClickListener actionPerformed = new OnClickListener() {
        ...
        public void onClick(View v) {
            // 按键上的命令获取
            String command = ((Button) v).getTag().toString();
            // 显示器上的字符串
    ...
    private void TipChecker(String tipcommand1, String tipcommand2) {
        ...
        if (tipcommand2.compareTo("DRG") == 0)
            Tipcode2 = 3;
        if (tipcommand2.compareTo("BACK") == 0)
            Tipcode2 = 4;
